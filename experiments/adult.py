...
for i in range(10):
    ...
    BTTKM = TT_model.BTTKM(D, R, M, pure_power_features_full, scale=2.1)
    ...
    TT_total_features.append(np.sum([BTTKM.R[d]*BTTKM.M[d]*BTTKM.R[d+1] for d in range(D)]))
