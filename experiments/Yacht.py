...
print("TT:\n")
print(f"mean RMSE:{np.mean(TT_RMSE)} with standard deviation:{np.std(TT_RMSE)}, rank:{np.mean([max(TT_rank) for TT_rank in TT_ranks])}, in {np.sum(TT_times)} seconds")
